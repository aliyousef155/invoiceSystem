                           ...
                           <div class="table-responsive">
                               <table class="table" id="invoice_details">
                                   ...
                                   <tr class="cloning_row" id="0">
                                       <td>#</td>
                                       <td><input type="text" name="product_name[0]"  class="product_name form-control"></td>
                                        @error('product_name') <span class="help-block text-danger">{{$message}}</span>@enderror

                                            <td>       <select name="unit[0]"  class="unit form-control">
                                                    <option value="">#</option>
                                       ...
                                       <td><input type="number" step="0.01" name="quantity[0]"  class="quantity form-control"></td>
                                        @error('quantity') <span class="help-block text-danger">{{$message}}</span>@enderror

                                       <td><input type="number" step="0.01" name="unit_price[0]"  class="unit_price form-control"></td>
                                       @error('unit_price') <span class="help-block text-danger">{{$message}}</span>@enderror

                                       <td><input type="number" step="0.01" name="row_sub_total[0]"  class="row_sub_total form-control" readonly="readonly"></td>
                                   ...
                                   <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td ><input type="number" step="0.01" name="sub_total" id="sub_total" class="sub_total form-control" readonly="readonly" value="0"></td>
                                        </tr>
                                            ...
                                            <td >
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append">
                                                        <input type="number" name="discount_value" id="discount_value" class="discount_value form-control" value="0.00" step="0.01">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td ><input type="number" step="0.01" name="shipping" id="shipping" class="shipping form-control" value="0"></td>
                                        </tr>
